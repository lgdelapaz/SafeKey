          ...
          <div className="space-y-6 mb-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Your encrypted passwords and personal information are stored
                  securely using industry-standard database protection with
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Access your vault using master password, PIN, or biometric
                  authentication. All authentication methods use secure
                  verification processes to protect your account.
                </p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  We collect only necessary account information (username, phone
                  number for verification) and your encrypted password data.
                  No personal browsing or usage analytics are collected.
                </p>
              </div>
            </div>
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  You maintain full control over your data. Account deletion
                  permanently removes all your information from our systems.
                  SMS notifications are used only for account verification.
                </p>
              </div>
            </div>
          </div>
